...
#ifndef __MT6516_NAND_H__
#define __MT6516_NAND_H__
...
#define ECC_ENCCON_REG16	(NFIECC_BASE+0x0000)
#define ECC_ENCCNFG_REG32  	(NFIECC_BASE+0x0004)
#define ECC_ENCDIADDR_REG32	(NFIECC_BASE+0x0008)
#define ECC_ENCIDLE_REG32  	(NFIECC_BASE+0x000C)
#define ECC_ENCPAR0_REG32   (NFIECC_BASE+0x0010)
#define ECC_ENCPAR1_REG32   (NFIECC_BASE+0x0014)
#define ECC_ENCPAR2_REG32   (NFIECC_BASE+0x0018)
#define ECC_ENCPAR3_REG32   (NFIECC_BASE+0x001C)
#define ECC_ENCPAR4_REG32   (NFIECC_BASE+0x0020)
#define ECC_ENCSTA_REG32    (NFIECC_BASE+0x0024)
#define ECC_ENCIRQEN_REG16  (NFIECC_BASE+0x0028)
#define ECC_ENCIRQSTA_REG16 (NFIECC_BASE+0x002C)

#define ECC_DECCON_REG16    (NFIECC_BASE+0x0100)
#define ECC_DECCNFG_REG32   (NFIECC_BASE+0x0104)
#define ECC_DECDIADDR_REG32 (NFIECC_BASE+0x0108)
#define ECC_DECIDLE_REG16   (NFIECC_BASE+0x010C)
#define ECC_DECFER_REG16    (NFIECC_BASE+0x0110)
#define ECC_DECENUM_REG32   (NFIECC_BASE+0x0114)
#define ECC_DECDONE_REG16   (NFIECC_BASE+0x0118)
#define ECC_DECEL0_REG32    (NFIECC_BASE+0x011C)
#define ECC_DECEL1_REG32    (NFIECC_BASE+0x0120)
#define ECC_DECEL2_REG32    (NFIECC_BASE+0x0124)
#define ECC_DECEL3_REG32    (NFIECC_BASE+0x0128)
#define ECC_DECEL4_REG32    (NFIECC_BASE+0x012C)
#define ECC_DECEL5_REG32    (NFIECC_BASE+0x0130)
#define ECC_DECIRQEN_REG16  (NFIECC_BASE+0x0134)
#define ECC_DECIRQSTA_REG16 (NFIECC_BASE+0x0138)
#define ECC_FDMADDR_REG32   (NFIECC_BASE+0x013C)
#define ECC_DECFSM_REG32    (NFIECC_BASE+0x0140)
#define ECC_SYNSTA_REG32    (NFIECC_BASE+0x0144)
#define ECC_DECNFIDI_REG32  (NFIECC_BASE+0x0148)
#define ECC_SYN0_REG32      (NFIECC_BASE+0x014C)
